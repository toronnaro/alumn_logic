...
<body>
    ...
    <main>
        <h1>My Dashboard</h1>
        <p class="text">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Consequatur animi voluptatibus cum maxime
            distinctio
        ...
        <p class="copyright">
            &copy; 2021 - <span>Arfanda Agung</span> All Rights Reserved.
        </p>
    </main>
